        ...
        <div class="card" v-show="heroes.length">
          ...
          <ul class="list is-hoverable">
            <li v-for="hero in heroes" :key="hero.id">
              <a class="list-item" @click="selectHero(hero)" :class="{ 'is-active': selectedHero === hero }">
        ...
        <div class="card">
          ...
          <div class="card-content">
            <div class="content">
              ...
              <div class="field">
                <label class="label" for="capeCounter">capeCounter</label>
                <input type="number" class="input" id="capeCounter" v-model="selectedHero.capeCounter" />
              </div>
              <div class="field">
                <label class="label" for="capeMessage">capeMessage</label>
                <label name="capeMessage" class="input">{{capeMessage}}</label>
              </div>
              <div class="field">
                <label class="label" for="originDate">originDate</label>
                <input type="date" name="originDate" class="input" v-model="selectedHero.originDate"/>
                <p class="comment">
  ...
  const ourHeroes = [
    {
      ...
      originDate : format( new Date(1988,5,1),inputDateFormat)
    },
    {
      id: 20,
      firstName: 'Madelyn',
