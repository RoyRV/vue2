          ...
          <div class="card-content">
            <div class="content">
              ...
              <div class="field">
                ...
                <textarea class="input" id="description" type="text" v-model="hero.description" ></textarea>
              </div>
              <div class="field">
              ...
              <div class="field">
                <label for="power">super power
                  <div class="select is-primary">
                    <select id="power" v-model="hero.power" @keyup.esc="clearPower"
